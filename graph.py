...
class SSFFGraph:
    ...
    def create_initial_state(
        ...
        return OverallState(
            ...
            founder_segmentation=None,
            founder_idea_fit=None,
            vc_prediction=None,
            categorization=None,
    ...
    def run_analysis(self, startup_info_str: str) -> dict[str, Any]:
        ...
        result = {
            ...
            'Founder Segmentation': final_state.get("founder_segmentation", ""),
            'Founder Idea Fit': final_state.get("founder_idea_fit", 0.0),
